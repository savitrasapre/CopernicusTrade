"""
Django settings for CopernicusFE project.
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:5173',
    'https://copernicus-trade.vercel.app'
]


ROOT_URLCONF = 'CopernicusFE.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'CopernicusFE', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'CopernicusFE.wsgi.application'
